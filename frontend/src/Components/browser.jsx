  ...
  return (
    ...
    >
      <Box backgroundColor={"black"} borderRadius={"5px"} padding={"5px"}>
        ...
        <Flex marginTop={"50px"} justifyContent={"flex-start"}>
          <Box
            width={"170px"}
            height={"270px"}
            backgroundColor={"#2C2C2C"}
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.querySelector(".hover-zoom").style.filter =
                "brightness(70%)";
            }}
            onMouseLeave={(e) => {
        ...
        <Flex marginTop={"50px"} justifyContent={"space-around"}>
          ...
          >
            ...
            <h5 style={{ padding: "5px" }}>
              A.R. Rahman, Pritam, Atif and more
            </h5>
          </Box>
          ...
          >
            ...
            <h5 style={{ padding: "5px" }}>
              Bilal saeed, Jaz Dhami, Falak Sabbir
            </h5>
          </Box>
        ...
        <Flex marginTop={"50px"} justifyContent={"space-around"}>
          ...
          >
            ...
            <h5 style={{ padding: "5px" }}>
              Sachet tondon, Pritam, shreya ghoshal
            </h5>
          </Box>
        ...
        <Flex marginTop={"50px"} justifyContent={"space-around"}>
          ...
          >
            ...
            <h5 style={{ padding: "5px" }}>
              wind down the summer heat with...
            </h5>
          </Box>
