...
export default function Sidebar() {
  return (
    ...
    <div style={{display:"flex", flexDirection:"column", backgroundColor:"#2C2C2C", width:"100%"}}>
      ...
      <img style={{width:"50%", height:"50px"}} src="https://i.ytimg.com/vi/704PL_KSLPY/maxresdefault.jpg" alt="" />
      ...
      <div style={{display:"flex", flexDirection:"column",backgroundColor:"gray", borderRadius:"6px",margin:"20px",  paddingTop:"20px", paddingBottom:"20px"}}>
        ...
        <button style={{width:"80%", borderRadius:"25px", backgroundColor:"white", border:"none", margin:"20px", color:"black", fontWeight:"bold", padding:"5px", fontSize:"17px",margin:"auto", marginTop:"30px"}}>Create Playlist</button>
      </div>


      <div style={{backgroundColor:"black", borderRadius:"6px",margin:"auto", height:"140px", marginTop:"50px", textAlign:"center"}}>
