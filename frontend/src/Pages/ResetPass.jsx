...
export default function ResetPass() {
  ...
  console.log(formdata.password, formdata.conpass);
  const handleSubmit = (e) => {
    ...
    dispatch(usereset(token, id, newpass))
      .then((res) => {
  ...
  return (
    ...
    >
      <Helmet>
        <title>Reset Password | Sa Re Ga Ma</title>
      </Helmet>
      <Box
      ...
      <Box w={{ base: "100%", sm: "100%", md: "48%", lg: "48%", xl: "48%" }}>
        ...
        >
          ...
          <Text>Write Your New Strong Password to Update Your Password.</Text>
          <br />
          <form
          ...
          >
            <FormControl isRequired>
              ...
              <FormHelperText color={err ? "red" : "black"} textAlign="justify">
